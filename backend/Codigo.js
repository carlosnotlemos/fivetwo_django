...
function configurarPlanilhas() {
  ...
  const abas = {
    ...
    "Estoque_Historico": ["Data/Hora", "Produto", "Tipo de Movimentação", "Quantidade", "Saldo Anterior", "Saldo Posterior", "Referência", "Observação"],
    ...
    "Custos": ["ID do Custo", "ID do Pedido", "Tipo de Custo", "Valor (R$)", "Data", "Descrição"],
...
function getAppState() {
  ...
  return {
    ...
    estoque: getEstoque(),
    historicoEstoque: getHistoricoEstoque(),
    vendas: getVendas(),
    custos: getCustos(),
